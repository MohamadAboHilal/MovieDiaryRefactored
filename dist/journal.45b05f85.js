...
})({"1WkWK":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "9bbc56d345b05f85";
"use strict";
...
},{}],"kd8Up":[function(require,module,exports,__globalThis) {
// journal
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _uiJs = require("./IlonaPaul/ui.js");
var _uiJsDefault = parcelHelpers.interopDefault(_uiJs);
document.addEventListener("DOMContentLoaded", ()=>{
    (0, _uiJsDefault.default)();
    console.log("Card List");
}); // document.addEventListener("DOMContentLoaded", renderCardList);

},{"./IlonaPaul/ui.js":"7kQJr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7kQJr":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function createMovieCard(movie) {
    ...
    if ((0, _localstorage.isFavorite)(movie.id)) favBtn.classList.add("text-red-500");
    favBtn.addEventListener("click", ()=>{
        (0, _localstorage.toggleFavorite)(movie, favBtn);
    });
    card.appendChild(favBtn);
    // Add note button
    const noteBtn = document.createElement("button");
    noteBtn.classList.add("mt-auto", "bg-teal-500", "text-white", "px-4", "py-2", "rounded-md", "transition", "self-start");
    const note = (0, _localstorage.getNoteForMovie)(movie.id);
...
function createNotePopup(movieId, noteBtn) {
    const existingNote = (0, _localstorage.getNoteForMovie)(movieId);
    ...
    document.getElementById("save-note").addEventListener("click", ()=>{
        ...
        (0, _localstorage.saveNoteForMovie)(movieId, noteText);
...
function renderCardList() {
    let favorites = (0, _localstorage.getFavorites)();
    favorites.forEach((favorite)=>createMovieCard(favorite));
}
exports.default = renderCardList;

},{"./localstorage":"5UHsz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5UHsz":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getFavorites", ()=>getFavorites);
parcelHelpers.export(exports, "getNoteForMovie", ()=>getNoteForMovie);
parcelHelpers.export(exports, "saveNoteForMovie", ()=>saveNoteForMovie);
...
},{}]},["1WkWK","kd8Up"], "kd8Up", "parcelRequire94c2")

//# sourceMappingURL=journal.45b05f85.js.map
